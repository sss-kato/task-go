...
// Package reopsitory is a generated GoMock package.
package repository
...
func (m *MockUserRepositoryIF) RegistUser(ud *dto.UserDto) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RegistUser", ud)
	ret0, _ := ret[0].(error)
	return ret0
}

// RegistUser indicates an expected call of RegistUser.
func (mr *MockUserRepositoryIFMockRecorder) RegistUser(ud interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RegistUser", reflect.TypeOf((*MockUserRepositoryIF)(nil).RegistUser), ud)
}
